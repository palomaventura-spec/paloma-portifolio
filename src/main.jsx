...
const t = {
  en: {
    ...
    projectText: 'AI-powered platform for Portuguese citizenship document analysis using OCR and artificial intelligence.',
  ...
  pt: {
    ...
    projectName: 'LexPortugal AI',
    projectText: 'Plataforma com IA para análise de documentos de cidadania portuguesa usando OCR e inteligência artificial.',
  ...
  es: {
    ...
    projectName: 'LexPortugal AI',
    projectText: 'Plataforma con IA para análisis documental de ciudadanía portuguesa usando OCR e inteligencia artificial.',
    ...
    <main>
      ...
      <section id="project" className="section">
        <div className="sectionTitle">
          <span>
            <BrainCircuit size={18} /> {c.projectTitle}
          </span>
          <h2>{c.projectName}</h2>
          <p>{c.projectText}</p>
        </div>
      ...
      <section className="section grid2">
        <div className="card">
          <h2>
            <Globe2 size={22} /> {c.languagesTitle}
          </h2>
        ...
        <div id="cv" className="card accent">
          <h2>CV</h2>
          <p>
            Add your PDF files to the public folder using the same file names
            below.
          </p>
